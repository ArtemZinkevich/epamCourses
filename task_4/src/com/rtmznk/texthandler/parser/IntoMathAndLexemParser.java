 ...
 */
class IntoMathAndLexemParser extends ChainParser {
    ...
    private ChainParser wordAndPunctParser;

    public IntoMathAndLexemParser() {
        symbolParser = new IntoSymbolParser();
        wordAndPunctParser = new IntoWordAndPunctuationParser();
    }
    ...
    TextComponent parse(String sentence) {
        ...
        while (matcher.find()) {
            ...
            if (Pattern.matches(MATH_REGEX, current)) {
                ...
                lexem.setLevel(TextChildLevel.LEXEME);
